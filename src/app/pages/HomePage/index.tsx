...
<div className="app">
	<div className="header">
		...
		<div className="header-menu">
			<a className="menu-link is-active" href="#">Apps</a> <a className="menu-link notify" href="#">Your work</a> <a className="menu-link" href="#">Discover</a> <a className="menu-link notify" href="#">Market</a>
		</div>
		...
		<div className="left-side">
			<div className="side-wrapper">
				...
				<div className="side-menu">
					...
					<path d="M192 192h128v128H192zm0 0" data-original="#82b1ff" fill="currentColor" xmlns="http://www.w3.org/2000/svg"></path>
					<path d="M384 192h128v128H384zm0 0M0 384h128v128H0zm0 0M192 384h128v128H192zm0 0M384 384h128v128H384zm0 0" data-original="#bfc9d1" fill="currentColor" xmlns="http://www.w3.org/2000/svg"></path></svg> All Apps</a> <a href="#"><svg viewBox="0 0 488.932 488.932">
					<path d="M243.158 61.361v-57.6c0-3.2 4-4.9 6.7-2.9l118.4 87c2 1.5 2 4.4 0 5.9l-118.4 87c-2.7 2-6.7.2-6.7-2.9v-57.5c-87.8 1.4-158.1 76-152.1 165.4 5.1 76.8 67.7 139.1 144.5 144 81.4 5.2 150.6-53 163-129.9 2.3-14.3 14.7-24.7 29.2-24.7 17.9 0 31.8 15.9 29 33.5-17.4 109.7-118.5 192-235.7 178.9-98-11-176.7-89.4-187.8-187.4-14.7-128.2 84.9-237.4 209.9-238.8z"></path></svg> Updates <span className="notification-number updates">3</span></a>
				</div>
			</div>
			<div className="side-wrapper">
				<div className="side-title">
				...
				<div className="side-menu">
					<a href="#"><svg viewBox="0 0 488.455 488.455">
